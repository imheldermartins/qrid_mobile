...
export const HeaderBalance = ({ username, businessName, balance = 0 }: HeaderBalanceProps) => {
    return (
        <View className='flex flex-col items-center gap-2 mb-6'>
            <Typography variant='h3' className='text-dark-800 text-2xl font-medium'>Olá, <Typography variant='h3' className='text-blue-500'>{username}</Typography></Typography>
            <Typography
                variant='h1'
            ...
            {businessName && <View className='flex flex-col items-center'>
                ...
                <Text className='text-dark-800 text-xl font-medium'>da <Text className='font-bold text-blue-700'>{businessName}</Text></Text>
            </View>}
        </View>
    )
}